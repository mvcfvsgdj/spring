...
/*
   ...
   public String kakaoPayGo(
         ...
         @RequestParam String detailed_address,
         @RequestParam String member_post,
         @RequestParam String delivery_req,
         Model model,
         OrderDTO orderDTO) {
      ProductDTO product = productservice.getProductById(board_id);
   ...
   public String kakaoPaySuccess(@RequestParam("pg_token") String pg_token,@RequestParam String board_id,
		   @RequestParam String board_title,
		   @RequestParam String user_nickname,
		   @RequestParam String board_price, Model model ) {
