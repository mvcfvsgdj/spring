...
public class KakaoPayService {
    ...
    public String kakaoPayReady(    String board_id,
        ...
        params.add("approval_url", "http://localhost:8090/secondHands/kakaoPaySuccess");
        params.add("cancel_url", "http://localhost:8090/secondHands/products");
        params.add("fail_url", "http://localhost:8090/secondHands/products");
