...
<div class="button-container">
    <form id="saveForm" action="/secondHands/update" method="post">
        ...
        <input type="hidden" name="user_id" id="user_id" value="<%= selectedUser.getUser_id() %>">
        <input  id="not-modify"  type="text" name="user_id" id="user_id" placeholder="<%= selectedUser.getUser_id() %> ( 아이디는 수정할 수 없습니다. )" readonly required>
