...
<div class="button-container">
    <form id="saveForm" action="/testing/update" method="post">
        ...
        <input type="hidden" name="user_pw" id="user_pw" value="<%= selectedUser.getUser_pw() %>" readonly required>

        <label for="address">이메일</label>
        <input type="text" name="address" id="address" value="<%= selectedUser.getAddress() %>" required>
        <label for="user_birth">생년월일</label>
        <input type="text" name="user_birth" id="user_birth" value="<%= selectedUser.getUser_birth() %>" >
