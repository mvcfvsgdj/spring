...
public class ProductRepository {
    ...
    //좋아요
    public void addLike(Map<String, Object> likeInfo) {
        session.insert(namespace + "addLike", likeInfo);
    }
    public void removeLike(Map<String, Object> likeInfo) {
        session.delete(namespace + "removeLike", likeInfo);
    }
    public int getLikeCount(String board_Id) {
        return session.selectOne(namespace + "getLikeCount", board_Id);
    }
